"""E2E test that an availability-zone swap preserves every volume's data.
...
Runnable in any order, unlike the other mutating files: ``volumes_provisioned`` provisions the
